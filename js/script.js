function Background(colour) {
  if (colour == "green") {
    document.getElementById("header").style.backgroundImage =
      "url('css/img/Green.svg')";
  } else if (colour == "blue") {
    document.getElementById("header").style.backgroundImage =
      "url('css/img/Blue.svg')";
  } else if (colour == "purple") {
    document.getElementById("header").style.backgroundImage =
      "url('css/img/Purple.svg')";
  }
...
window.onload = function () {
  ...
  addButton.onclick = function () {
    ...
    if (toDo) {
      colourIndex = colours.indexOf(
        getComputedStyle(colourButton).backgroundColor
      );
  ...
  function completeToDo(element) {
    ...
    var moveTo =
      element.parentElement.parentElement.id == "list" ? completed : list;
